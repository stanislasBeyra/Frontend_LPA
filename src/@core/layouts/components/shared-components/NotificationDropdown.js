  ...
  return (
    <Fragment>
      ...
      >
        <MenuItem disableRipple>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
            ...
            <Chip
              size='small'
              label='8 New'
              sx={{ color:whiteColor, background:teelColor, height: 20, fontSize: '0.75rem', fontWeight: 500, borderRadius: '10px' }}
            />
          </Box>
        </MenuItem>
        <ScrollWrapper>
        ...
        >
          <MyButton fullWidth variant='contained' onClick={handleDropdownClose}>
