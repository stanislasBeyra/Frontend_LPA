...
//     const platform = typeof navigator !== 'undefined' ? navigator.platform : 'SSR'
//     const language = typeof navigator !== 'undefined' ? navigator.language : 'SSR'
...
//     let location = { latitude: 'Inconnu', longitude: 'Inconnu' }
//     try {
...
//     return { userAgent, platform, language, ipAddress, ...location }
//   }
