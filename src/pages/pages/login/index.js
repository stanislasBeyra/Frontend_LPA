...
import LinearProgress from '@mui/material/LinearProgress' // Importation de la barre de progression
...
import { teelColor, whiteColor,orangeColor, blueColor } from 'src/utils/config'
...
const LoginPage = () => {
  ...
  const [loading, setLoading] = useState(false) // État pour gérer la barre de progression
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      setLoading(true) // Affiche la barre de progression au début de la soumission
      try {
        ...
        setLoading(false) // Cache la barre de progression une fois que la requête est terminée
      }
    }
  }
        ...
        <CardContent sx={{ padding: (theme) => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <form noValidate autoComplete='off' onSubmit={handleSubmit}>
            ...
            {loading ? (
              <LinearProgress
              sx={{
                backgroundColor: teelColor, // Couleur de fond de la barre (non défilante)
                '& .MuiLinearProgress-bar': {
                  backgroundColor: blueColor, // Couleur de la barre qui défile
                },
                borderRadius: '5px',
                height: 10,
              }}
